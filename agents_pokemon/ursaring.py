...
class UrsaringAgent(AnimalAgent):
    def __init__(self, agent_id: str = "ursaring_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Ursaring"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["resistência"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["força massiva"]
        
        self.solo_behavior = "controle espaço"
        self.group_behavior = "sustente combate"
        self.rival_response = "confronto direto"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['controle espaço']
        self.collective_tactics = ['sustente combate']
        self.threat_tactics = ['confronto direto']
