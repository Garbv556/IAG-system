...
class BarraskewdaAgent(AnimalAgent):
    def __init__(self, agent_id: str = "barraskewda_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Barraskewda"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["ataque linear"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["velocidade absurda"]
        
        self.solo_behavior = "ataque direto"
        self.group_behavior = "pressione continuamente"
        self.rival_response = "ataque e reposicione"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['ataque direto']
        self.collective_tactics = ['pressione continuamente']
        self.threat_tactics = ['ataque e reposicione']
