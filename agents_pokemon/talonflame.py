...
class TalonflameAgent(AnimalAgent):
    def __init__(self, agent_id: str = "talonflame_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Talonflame"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["visão", "precisão"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["velocidade aérea extrema"]
        
        self.solo_behavior = "observe e ataque rápido"
        self.group_behavior = "forneça informação"
        self.rival_response = "ataque e saia"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['observe e ataque rápido']
        self.collective_tactics = ['forneça informação']
        self.threat_tactics = ['ataque e saia']
