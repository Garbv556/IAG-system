...
class DubwoolAgent(AnimalAgent):
    def __init__(self, agent_id: str = "dubwool_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Dubwool"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["defesa + colisão"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["impacto físico"]
        
        self.solo_behavior = "avalie antes"
        self.group_behavior = "entre quando necessário"
        self.rival_response = "ataque direto"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['avalie antes']
        self.collective_tactics = ['entre quando necessário']
        self.threat_tactics = ['ataque direto']
