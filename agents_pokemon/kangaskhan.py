...
class KangaskhanAgent(AnimalAgent):
    def __init__(self, agent_id: str = "kangaskhan_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Kangaskhan"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["equilíbrio"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["combate técnico"]
        
        self.solo_behavior = "lute com controle"
        self.group_behavior = "proteja aliados"
        self.rival_response = "contra-ataque"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['lute com controle']
        self.collective_tactics = ['proteja aliados']
        self.threat_tactics = ['contra-ataque']
