...
class CinderaceAgent(AnimalAgent):
    def __init__(self, agent_id: str = "cinderace_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Cinderace"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["agilidade"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["velocidade", "fogo técnico"]
        
        self.solo_behavior = "ataque rápido e saia"
        self.group_behavior = "crie oportunidades"
        self.rival_response = "evasão imediata"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['ataque rápido e saia']
        self.collective_tactics = ['crie oportunidades']
        self.threat_tactics = ['evasão imediata']
