...
class FeraligatrAgent(AnimalAgent):
    def __init__(self, agent_id: str = "feraligatr_001"):
        super().__init__(agent_id=agent_id)
        # O construtor chama _set_animal_characteristics internamente.
        
    def _set_animal_characteristics(self) -> None:
        self.animal_name = "Feraligatr"
        self.species = "Pokémon"
        self.environment = "Mundo Pokémon"
        self.characteristics = ["emboscada"]
        # Adicionamos "powers" dinamicamente no dict ou na base se quiser
        self.powers = ["força aquática"]
        
        self.solo_behavior = "espere o momento certo"
        self.group_behavior = "ataque quando o alvo estiver vulnerável"
        self.rival_response = "ataque surpresa"
        
        # ═══ DOUTRINA TÁTICA ═══
        self.solo_tactics = ['espere o momento certo']
        self.collective_tactics = ['ataque quando o alvo estiver vulnerável']
        self.threat_tactics = ['ataque surpresa']
